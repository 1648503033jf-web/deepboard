...
DeepDashboard 在 DeepFlow 数据能力之上，构建了完整的智能运维平台，特别加入了 DeepFlow 原生不提供的 AI 诊断、RAG 知识库、SLO 管理、工作流编排等能力。
...
![image-20260514134136437](https://jairmir-image.oss-cn-shanghai.aliyuncs.com/img/image-20260514134136437.png)

### Universal Map 服务拓扑

![image-20260514134221542](https://jairmir-image.oss-cn-shanghai.aliyuncs.com/img/image-20260514134221542.png)



![image-20260514134245722](https://jairmir-image.oss-cn-shanghai.aliyuncs.com/img/image-20260514134322596.png)

### AI 智能诊断

![image-20260514134345716](https://jairmir-image.oss-cn-shanghai.aliyuncs.com/img/image-20260514134345716.png)

### DeerFlow 多 Agent 对话

![image-20260514134422570](https://jairmir-image.oss-cn-shanghai.aliyuncs.com/img/image-20260514134422570.png)

### 全栈路径追踪

![image-20260514134509422](https://jairmir-image.oss-cn-shanghai.aliyuncs.com/img/image-20260514134509422.png)

### 告警管理

![image-20260514134535855](https://jairmir-image.oss-cn-shanghai.aliyuncs.com/img/image-20260514134535855.png)

### 工作流编排

![image-20260514134629975](https://jairmir-image.oss-cn-shanghai.aliyuncs.com/img/image-20260514134629975.png)

### 自定义大盘

![](https://jairmir-image.oss-cn-shanghai.aliyuncs.com/img/image-20260514134552658.png)
...
| `AI_API_BASE_URL`           | LLM API 地址             | `http://mini-gateway.dc.abc.com/v1`     |
| `AI_MODEL`                  | 默认 LLM 模型            | `MiniMax-M2.7`                          |
| `MYSQL_HOST`                | MySQL 数据库地址         | `10.135.2.10`                           |
| `REDIS_HOST`                | Redis 缓存地址           | `localhost`                             |
| `PROMETHEUS_URL`            | Prometheus/夜莺地址      | `http://n9e.dc.abc.com/api/n9e/proxy/1` |
| `DEERFLOW_ORCHESTRATOR_URL` | DeerFlow Agent 地址      | `http://deerflow-orchestrator:8080`     |
